...
export const TRENDING_PLANTS: Plant[] = [
  {
    ...
    name: "Swiss Cheese",
    category: "Indoor Plant",
    description: "I recently added a beautiful Swiss Cheese plant to my workspace, and it has made such a positive difference!",
    price: 340,
    imageUrl: "https://images.unsplash.com/photo-1614594975525-e45190c55d0b?auto=format&fit=crop&q=80&w=600",
    isTrending: true,
    tag: "Sale"
  ...
  },
  {
    ...
    name: "Snake Plant",
    category: "Indoor Plant",
    description: "Adjoining gorgeous tall upright leaves that purify indoor air throughout the day and night.",
    price: 420,
    imageUrl: "https://images.unsplash.com/photo-1596547609652-9cf5d8d76921?auto=format&fit=crop&q=80&w=600",
    isTrending: true,
    tag: "New"
